...
const HomeDefine = () => {
    return (
        <>
            <div className="flex items-center flex-col lg:flex-row md:flex-row justify-center gap-5 p-5">
                ...
                <div className='w-full md:w-1/2 lg:w-1/2 '>
                    <div className='border-2 border-white rounded-full w-2/3 lg:w-1/3 h-auto mx-auto'>
